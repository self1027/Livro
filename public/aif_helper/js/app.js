import {
	MAPA_INFRACOES
} from "/aif_helper/js/mapaInfracoes.js"
import {
	resolverBases
} from "/aif_helper/js/resolverBases.js"
...
<div class="card mb-3 shadow-sm">
	...
	<div class="card-body">
		...
		Array.from(artigosMap.values()).forEach(a => {
			...
			const artigoHtml = `
<a href="javascript:void(0)" class="font-weight-bold text-decoration-underline"
...
`
			...
			if (a.paragrafo) {
				...
				if (parData) {
					paragrafoHtml = `
§
<a href="javascript:void(0)" class="font-weight-normal text-decoration-underline"
data-bs-toggle="popover" data-bs-trigger="hover focus"
data-bs-html="true"
...
`
          ...
          Origem: ${Array.from(a.origem).join(", ")}
          </div>` :
                  ""
